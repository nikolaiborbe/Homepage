...
<div class="lg:max-w-[1140px]">
	<div class="m-auto max-sm:px-4">
		<NGB />
		<h3
			class="text-gray-400 text-xl font-light pt-12 pb-32 text-center lg:px-48 px-2 leading-relaxed"
		>
			I'm a <span class="font-bold">
				<Age {b_date} />
			</span>
			year-old
			<span>
			...
			who enjoys programming, video games, and
			<span>
